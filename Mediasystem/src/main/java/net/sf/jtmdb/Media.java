      ...
      if (session != null && session.getSession() != null
        ...
        try {
          ...
          try {
            ...
            Log.log("Unknown error while adding Media ID for movie", Verbosity.ERROR);
  ...
  public static Movie getInfo(String dvdID) throws IOException, JSONException {
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        Log.log("Getting info for Movie with DVD ID " + dvdID	+ " returned no results", Verbosity.NORMAL);
      }
      catch (IOException e) {
        Log.log(e, Verbosity.ERROR);
        throw e;
  ...
  public static List<Movie> getInfo(String hash, long byteSize)
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        Log.log("Getting info for Movie with hash " + hash + " and bytesize " + byteSize + " returned no results", Verbosity.NORMAL);
      }
      catch (IOException e) {
        Log.log(e, Verbosity.ERROR);
        throw e;
