...
public class Movie implements Serializable {
   ...
   * @throws JSONException
   */
  public static List<Movie> deepSearch(String nameParameter) throws IOException, JSONException {
    Log.log("Performing a deep Movie search for \"" + nameParameter + "\"", Verbosity.NORMAL);
      ...
      if (name != null && !name.equals("")) {
        try {
          ...
          if ((jsonString.startsWith("[") || jsonString
            ...
            Log.log("Search for \"" + name + "\" returned no results", Verbosity.NORMAL);
          }
          return results;
        }
        catch (IOException e) {
   ...
   * @throws JSONException
   */
  public static List<Movie> search(String nameParameter) throws IOException, JSONException {
    Log.log("Performing a Movie search for \"" + nameParameter + "\"", Verbosity.NORMAL);
    String name;
  ...
  public static Movie getInfo(int ID) throws IOException, JSONException {
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        Log.log("Getting info for Movie with id " + ID + " returned no results", Verbosity.NORMAL);
      } catch (IOException e) {
        Log.log(e, Verbosity.ERROR);
        throw e;
      } catch (JSONException e) {
  ...
  JSONException {
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        Log.log("Search for images of Movie with id " + ID + " returned no results", Verbosity.NORMAL);
      }
      catch (IOException e) {
        Log.log(e, Verbosity.ERROR);
        throw e;
  ...
  JSONException {
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        Log.log("Getting version for Movie with id " + ID + " returned no results", Verbosity.NORMAL);
      }
      catch (IOException e) {
        Log.log(e, Verbosity.ERROR);
        throw e;
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        if ((jsonString.startsWith("[") || jsonString.startsWith("{"))
          ...
          Log.log("Getting version for list of Movies with ids " + listIDs + " returned no results", Verbosity.NORMAL);
        }
        return versionInfo;
      }
      catch (IOException e) {
  ...
  JSONException {
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        Log.log("Getting latest Movie entry returned no results", Verbosity.NORMAL);
      }
      catch (IOException e) {
        Log.log(e, Verbosity.ERROR);
        throw e;
  ...
  public static Pair<MovieVersionInfo, List<Translation>> getTranslations(
    ...
    if (GeneralSettings.getApiKey() != null
      ...
      try {
        ...
        Log.log("Getting translations for Movie with id " + imdbID + " returned no results", Verbosity.NORMAL);
      }
      catch (IOException e) {
        Log.log(e, Verbosity.ERROR);
        throw e;
      ...
      if (session != null && session.getSession() != null
        ...
        try {
          ...
          try {
            ...
            Log.log("Unknown error while rating movie", Verbosity.ERROR);
